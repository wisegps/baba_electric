...
public class FragmentHome extends Fragment {
		...
		for (int i = 0; i < sharedCards.length; i++) {
			...
			if (cardName.equals(Const.TAG_POI)) {
				...
				cards.put(Const.TAG_AIR, fragmentHomeAir);
					...
					FragmentElectricCarInfo fragmentElectricCarInfo = new FragmentElectricCarInfo();
					
					fragmentElectricCarInfo.setOnCardMenuListener(onCardMenuListener);
	...
	public void setLoginOutView() {
		...
		FragmentElectricCarInfo fragmentElectricCarInfo = (FragmentElectricCarInfo) cards
